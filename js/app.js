...
const updatePrice = (id, value) => {
  ...
  const productPrice = document.getElementById(id).innerText = floatTotal.toFixed(2);
};

// set innerText function
const setInnerText = (id, value) => {
  const floatCharge = parseFloat(value);
  const totalCharge = floatCharge.toFixed(2);
  document.getElementById(id).innerText = totalCharge;
};
